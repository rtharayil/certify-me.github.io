...
faqs:
  - title: "Digital Credentials - Basics"
    questions:
      - "What is a digital credentialing service?"
  ...
  - title: "Verifiable Credentials - Basics"
    questions:
      ...
      - "What is the difference between digital credentials and verifiable credentials?"
      - "What does “verifiable” mean in digital credentials?"
      - "What standards govern verifiable credentials (W3C, Open Badges, etc.)?"
      - "What does it mean to verify credentials?"
      - "Are verified credentials legit?"
      - "What is an example of a verifiable credential?"
      - "How are verifiable credentials different from digitally signed PDFs?"
      - "Why use verifiable credentials?"
      - "What are verifiable credentials used for?"
      - "What are the benefits of verifiable credentials?"

  - title: "Higher-Ed & Issuer Use Cases"
    questions:
      - "How to verify digital credentials issued by educational institutions?"
      - "How do universities ensure long-term verifiability of issued credentials?"
      - "How to choose a verifiable credential provider for secure student record management?"
      - "What compliance considerations matter when issuing digital credentials?"
  ...
  - title: "Verification, Security & Trust"
    questions:
      - "How to verify authenticity of verifiable credentials issued by third parties?"
      - "How does cryptographic verification work in verifiable credentials?"
      - "What makes a digital credential tamper-evident?"
      - "What is credential revocation and why does it matter for compliance?"
      - "What are the security risks of non-verifiable digital certificates?"
      - "How does QR-code-based verification work for verifiable credentials?"
      - "How to transfer verifiable credentials between different digital wallet services?"

  - title: "Digital Credential Platforms"
    questions:
      - "What features should I look for in secure digital credential software?"
      - "Which digital credential software offers the best integration with learning management systems?"
  ...
  #     - "What are the top digital credential software platforms for professional certifications?"
  #     - "Where can I find digital credential software providers specializing in higher education?"
  #     - "How to compare pricing plans of popular digital credential software solutions?"
  #     - "What are the easiest digital credential software tools for small businesses?"
  #     - "How to choose a digital credential platform for online courses?"
  #     - "Which companies offer secure digital credential solutions for universities?"
  #     - "Can I get a free trial of a digital credential platform for small businesses?"
