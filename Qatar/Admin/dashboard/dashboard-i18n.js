...
(function () {
  var DICT = {
    ...
    jan25: { en: 'Jan', ar: 'يناير' },
    feb25: { en: 'Feb', ar: 'فبراير' },
    mar25: { en: 'Mar', ar: 'مارس' },
    apr25: { en: 'Apr', ar: 'أبريل' },
    may25: { en: 'May', ar: 'مايو' },
    ...
    createCompetency: { en: 'Competencies<br>Management', ar: 'إدارة<br>الكفاءات' },
    createBadge: { en: 'Badges<br>Management', ar: 'إدارة<br>الشارات' },
    addStudents: { en: 'Students<br>Management', ar: 'إدارة<br>الطلاب' },
    createOpportunity: { en: 'Opportunities<br>Management', ar: 'إدارة<br>الفرص' },
