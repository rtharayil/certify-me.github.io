...
(function () {
  var DICT = {
    ...
    hbkuName: { en: 'Hamad Bin Khalifa University', ar: 'جامعة حمد بن خليفة' },
    ...
    level3Proficient: { en: 'Level 3 - Proficient', ar: 'المستوى 3 - متمكن' },
    level2Intermediate: { en: 'Level 2 - Intermediate', ar: 'المستوى 2 - متوسط' },
    ...
    level3ProficientBr: { en: 'Level 3<br>Proficient', ar: 'المستوى 3<br>متمكن' },
    level2IntermediateBr: { en: 'Level 2<br>Intermediate', ar: 'المستوى 2<br>متوسط' },
    level1FoundationalBr: { en: 'Level 1<br>Foundational', ar: 'المستوى 1<br>تأسيسي' },
    level4AdvancedBr: { en: 'Level 4<br>Advanced', ar: 'المستوى 4<br>متقدم' },
    ...
    level3ProficientDash: { en: 'Level 3 – Proficient', ar: 'المستوى 3 – متمكن' },
    level2IntermediateDash: { en: 'Level 2 – Intermediate', ar: 'المستوى 2 – متوسط' },
