...
(function () {
  var DICT = {
    ...
    onetOption: { en: 'O*NET – U.S. Occupational Skills and Knowledge Taxonomy', ar: 'O*NET – تصنيف المهارات والمعارف المهنية الأمريكي' },
    ...
    treeK: { en: 'K - Social Sciences, Journalism and Information (245)', ar: 'K - العلوم الاجتماعية والصحافة والإعلام (245)' },
    treeL: { en: 'L - Legal Studies and Public Administration (198)', ar: 'L - الدراسات القانونية والإدارة العامة (198)' },
    treeM: { en: 'M - Creative Arts and Media Production (167)', ar: 'M - الفنون الإبداعية وإنتاج الإعلام (167)' },
    treeN: { en: 'N - Hospitality, Tourism and Leisure (203)', ar: 'N - الضيافة والسياحة والترفيه (203)' },
    treeO: { en: 'O - Transportation and Logistics (287)', ar: 'O - النقل والخدمات اللوجستية (287)' },
    treeP: { en: 'P - Personal Services and Wellbeing (142)', ar: 'P - الخدمات الشخصية والرفاهية (142)' },
    treeQ: { en: 'Q - Public Safety and Security (176)', ar: 'Q - السلامة والأمن العام (176)' },
    treeR: { en: 'R - Retail and Sales (321)', ar: 'R - البيع بالتجزئة والمبيعات (321)' },
    treeS: { en: 'S - Sports, Recreation and Fitness (158)', ar: 'S - الرياضة والترفيه واللياقة (158)' },
    treeT: { en: 'T - Telecommunications and Networks (194)', ar: 'T - الاتصالات والشبكات (194)' },
    treeU: { en: 'U - Urban Planning and Architecture (113)', ar: 'U - التخطيط العمراني والعمارة (113)' },
    treeV: { en: 'V - Veterinary Science and Animal Care (97)', ar: 'V - الطب البيطري ورعاية الحيوان (97)' },
    treeW: { en: 'W - Wholesale Trade and Supply Chain (162)', ar: 'W - تجارة الجملة وسلسلة التوريد (162)' },
    treeX: { en: 'X - X-Ray and Diagnostic Imaging (54)', ar: 'X - الأشعة والتصوير التشخيصي (54)' },
    treeY: { en: 'Y - Youth and Community Services (88)', ar: 'Y - خدمات الشباب والمجتمع (88)' },
    treeZ: { en: 'Z - Zoology and Wildlife Conservation (61)', ar: 'Z - علم الحيوان وحماية الحياة البرية (61)' },
